    ...
    <div class="row gy-4">
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nameTheme" placeholder="Theme 1" value="{{ $catalog->name ?? "" }}">
            </div>
            <div class="mb-3">
                <label for="description" class="form-label">Описание:</label>
                <textarea class="form-control" id="description" rows="3">{{ $catalog->description }}</textarea>
            </div>
